...
install_pip="python3.11 -m pip install --upgrade pip && python3.11 -m pip install -r requirements-build.txt"

tox_command="python3.11 -m tox -e py311-pypi,py312-pypi,audit_2_27"
