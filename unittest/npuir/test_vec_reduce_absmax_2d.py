...
def vec_reduce_absmax(M, N, block_M, block_N, dtype="float16"):
    m_num = M // block_M
    n_num = N // block_N
    ...
    def main(
        ...
        with T.Kernel(m_num * n_num, is_npu=True) as (cid, _):
            ...
            T.npuir_reduce(A_VEC, B_VEC, [1], "absmax", [128, 128])
            T.copy(B_VEC[0:128, 0:1], B[bx : bx + 128, 0:1])

    return main


def test_vec_reduce_absmax():
    func = vec_reduce_absmax(M, N, 128, 256)
